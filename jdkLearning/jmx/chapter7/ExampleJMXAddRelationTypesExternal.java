...
public class ExampleJMXAddRelationTypesExternal {

       private static MBeanServer server = null;


       public ExampleJMXAddRelationTypesExternal(){
              server = MBeanServerFactory.createMBeanServer();
       }

       public static void main(String args[]){

              ExampleJMXAddRelationTypesExternal agent = 
                        new ExampleJMXAddRelationTypesExternal();
              ...
              try {
                  ...
                  HMIRelationType hmiRelType = 
                           new HMIRelationType("Organization Printers",
                                               new RoleInfo[]{rInfo});

                  relServ.addRelationType(hmiRelType);

                  // Use our homegrown relation type //
                  HMIRelationTypeDirect hmiRelTypeDirect =
                     new HMIRelationTypeDirect("IT Printers",
                                               new RoleInfo[]{rInfo});

                  relServ.addRelationType(hmiRelTypeDirect);
