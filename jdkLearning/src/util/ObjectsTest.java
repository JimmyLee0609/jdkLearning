...
public class ObjectsTest {
	...
	public static void main(String[] args) {
		...
		// Domain requireNonNull3 = Objects.requireNonNull(null,
		// "domian2NonNUll"); 如果对象是null就将mesg传入异常信息

		String string = Objects.toString(domain);// Domain [index=10,
													// name=10domain]
		String string2 = Objects.toString(domain, "domain Objects toString");// Domain
																				// [index=10,
																				// name=10domain]
		String string3 = Objects.toString(null, "domain Objects toString");// domain
																			// Objects
																			// toString
																			// 传入的对象是null就返回message

		boolean equals = Objects.equals(domain, domain2);// false a.equals(b)
															// 判断两个对象是否相等
		boolean deepEquals = Objects.deepEquals(domain2, domain);// false
																	// Arrays.deepEquals0(a,
																	// b);
																	// 深层次的比较两个对象
		// 使用比较器 比较两个对象是否相等
