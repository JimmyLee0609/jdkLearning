...
public class LocaleTest {
	...
	public static void main(String[] args) {
		...
		// 标签 - 用于匹配的语言字符串
		String lookupTag = Locale.lookupTag(Locale.LanguageRange.parse("en-US;q=1.0,en-GB;q=0.5,fr-FR;q=0.0"),
	...
	private static void filter() {
		...
		list.add(german);
		list.add(canadaFrench);
		list.add(chinese);
		list.add(canada);
		tags.add(languageTag4);
		tags.add(languageTag3);
		tags.add(language2);
