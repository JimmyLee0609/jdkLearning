...
public class CalendarTest {
	...
	public static void main(String[] args) {
		...
		String displayName = instance.getDisplayName(Calendar.MONTH, Calendar.LONG_FORMAT, Locale.getDefault());
		// 获取字段的最大值的最小值
		...
		instance.roll(Calendar.MONTH, false); // 将月份向后回滚 8月->7月
												// true就会往前滚，超过年的月份限制，调整年
